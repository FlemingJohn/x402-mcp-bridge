...
export const FeaturesGrid: React.FC = () => (
  <section id="portfolio" className="max-w-7xl mx-auto mt-24 scroll-mt-24">
    <div className="text-center mb-16">
      <h3 className="text-4xl font-bold text-white serif mb-4">Unrivaled Intelligence</h3>
      <p className="text-silver/40 max-w-xl mx-auto">Sophisticated tools designed for managing diverse luxury portfolios with absolute precision.</p>
    </div>
